<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="EditEmployee.aspx.vb" Inherits="DashBoardClinicManagmmantSystem.EditEmployee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="medical-report-container">
        <div class="report-title">تعديل بيانات الموظف</div>
        ...
        <div class="report-section">
            <div class="flex-50">
                ...
                <asp:TextBox ID="txtEmployeeName" runat="server" CssClass="report-input" MaxLength="150"></asp:TextBox>
            </div>
            ...
            <div class="flex-50">
                ...
                <div>
                    <asp:RadioButton ID="rbSocialRegistered" runat="server" GroupName="SocialStatus" Text="مسجل" AutoPostBack="True" OnCheckedChanged="rbSocialStatus_CheckedChanged" />
                    <asp:RadioButton ID="rbSocialUnregistered" runat="server" GroupName="SocialStatus" Text="غير مسجل" AutoPostBack="True" OnCheckedChanged="rbSocialStatus_CheckedChanged" />
                </div>
            </div>
        ...
        <div class="report-actions">
            <asp:Button ID="btnSave" runat="server" CssClass="btn-save" Text="تحديث البيانات" OnClick="btnSave_Click" />
