<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="EditSuppliers.aspx.vb" Inherits="DashBoardClinicManagmmantSystem.EditSuppliers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="medical-report-container">
        <div class="report-title">تعديل بيانات المورد</div>
        ...
        <div class="report-actions">
            ...
            <asp:Button ID="btnBack" runat="server" CssClass="btn-back" Text="⬅ رجوع" PostBackUrl="SuppliersList.aspx" />
        </div>
    </div>
</asp:Content>
