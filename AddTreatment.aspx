<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="AddTreatment.aspx.vb" Inherits="DashBoardClinicManagmmantSystem.AddTreatment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="direction: rtl; max-width: 700px; margin: auto; background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,.1)">
        <h2 style="margin-bottom: 15px;">إضافة إجراء جديد</h2>
