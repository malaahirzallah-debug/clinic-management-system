<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="EditGroup.aspx.vb" Inherits="DashBoardClinicManagmmantSystem.EditGroup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="direction:rtl; max-width:600px; margin:auto; background:#fff; padding:20px; border-radius:10px; box-shadow:0 2px 5px rgba(0,0,0,.1)">
        <h2 style="margin-bottom:15px;">تعديل المجموعة</h2>
        ...
        <asp:Button ID="btnUpdate" runat="server" Text="تحديث" CssClass="btn btn-success" />
